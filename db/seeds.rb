...
Tag.create!(label: "domestic")

Tag.create!(label: "import")

Tag.create!(label: "premium")

Tag.create!(label: "glass")

Tag.create!(label: "can")

Tag.create!(label: "carafe")

Tag.create!(label: "pitcher")
